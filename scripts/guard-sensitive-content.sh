#!/bin/sh
# Sensitive-content guard for postmortem-generator: refuses a commit
...
# identifiers, AI-attribution strings. Invoked by
# scripts/hooks/pre-commit (core.hooksPath wiring).
#
